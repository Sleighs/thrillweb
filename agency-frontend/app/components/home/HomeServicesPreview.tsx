    ...
    <div className="home-services-preview">
      <div className="home-services-preview--content">
        ...
        <div className="home-services-preview--title-container">
          ...
          <div className="home-services-preview--description">We provide a wide range of digital marketing services, such as brand identity design, mobile app development, and SEO. Your company will have the web exposure it deserves thanks to our efficient method.</div>
        </div>
